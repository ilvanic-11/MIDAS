...
class MayaviSampleView(HasTraits):
...
class Mayavi3idiView(HasTraits):
    ...
    def __init__(self):
        ...
        awesome3idi = Mayavi3idiArtAnimation.Mayavi3DAnimator()
        # -1
        ##Acquire Data
        ...
        Points = awesome3idi.standard_reorientation(Points, 2)
...
class MainWindow(wx.Frame):
    ...
    def __init__(self, parent, id):
        ...
        # self.mayavi_view3 = Mayavi3idiView()
        #
        # # The third call to edit_traits opens a OUR MUSIC SHIT!
        # self.control3 = self.mayavi_view3.edit_traits(
        #     parent=self,
        #     kind='subpanel').control
        # self.notebook.AddPage(page=self.control3, caption= '3idiArt Display')
