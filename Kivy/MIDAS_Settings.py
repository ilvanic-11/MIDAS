...
key = ""
key_list = ["A", "A#m", "Ab", "Abm", "Am", "B", "Bb", "Bbm", "Bm", "C", "C#", "C#m", "Cb", "Cm", "D", "D#m", "Db", "Dm", "E", "Eb", "Ebm", "Em", "F", "F#", "F#m", F"m", "G", "G#m" ,"Gb", "Gm"]
...
#This functionality is not intended for FL Studio Mobile, instead FL Studio >= 20
